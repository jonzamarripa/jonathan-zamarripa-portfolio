...
@media(max-width:768px){.hero{min-height:auto}.hero-content{min-height:auto;padding-top:48px;padding-bottom:360px;grid-template-columns:1fr}.hero-copy{width:100%;margin-left:0;margin-right:0}.hero-eyebrow{margin-bottom:18px}.hero-title{font-size:clamp(2rem,5vw,3.2rem);margin:0 0 24px}.hero-description{font-size:clamp(1rem,3.5vw,1.375rem);margin:0 0 18px;max-width:100%}.hero-manifesto{font-size:1rem;max-width:100%;margin:0 0 24px}.hero-portrait{right:50%;bottom:-10px;width:min(480px,100vw);transform:translateX(50%) translateY(20px);height:auto;max-height:none;opacity:.88}.hero-portrait-backlight{right:50%;top:auto;bottom:-16%;width:110vw;height:480px;transform:translateX(50%);opacity:.7}.hero-portrait-haze{right:-5%;bottom:-5%;width:110%;opacity:.5}.hero-foreground-atmosphere{opacity:.5}}
@media(max-width:600px){.hero-content{padding-top:40px;padding-bottom:300px}.hero-title{font-size:clamp(1.75rem,4vw,2.8rem);margin:0 0 20px}.hero-description{font-size:clamp(.9375rem,3vw,1.1875rem);margin:0 0 16px}.hero-manifesto{font-size:.9375rem;margin:0 0 20px}.hero-eyebrow{margin-bottom:14px}.hero-portrait{width:min(380px,95vw);bottom:-8px}.hero-portrait-backlight{height:380px}}
